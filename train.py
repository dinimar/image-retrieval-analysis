...
if __name__ == "__main__":
    ...
    parser.add_argument('--num_samples', type=int, default=0, help='number of samples per class')
    parser.add_argument('--top_num_classes', type=int, default=0, help='number of classes that will be used for training.\n'+
                                                                       'Classes sorted by number of samples and top n classes used for training.')
    ...
    train_loader, val_loader, num_classes = create_dataloader(
        ...
        top_num_classes=args.top_num_classes,
